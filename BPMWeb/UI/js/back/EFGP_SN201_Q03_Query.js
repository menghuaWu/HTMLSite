...
/*
var gridAttributes_init = [{
    caption: "",
    gid: "jqGridMain",
    pager: "#jqGridPagerMain",
	colAPI: 'EFS_SN201_Q03_Query', //set colModel index
...
var gridAttributes = [{
    caption: "Open SO List",
    gid: "jqGridMain",
    pager: "#jqGridPagerMain",
    //colAPI: 'EFS_SN201_Q03_Query', //set colModel index
    //fixedColFDb: true, //set db  
    gridDefinitionUrl: invokeURL + 'EFS_SN201_Q03_Query', 
    search: true,
    refresh: true,
    xls: true, 
    //fixedColFDb: false,
...
$(document).ready(function () {
   ...
   /* let option=
        { //grid初始化參數
            ...
            // fixedColFDb: true, //set db
            gridDefinitionUrl: invokeURL + 'EFS_SN201_Q03_Query',
            //gridDefinitionUrl: invokeURL + 'EFS_JQTEST',
            //gridDefinitionUrl: invokeURL + 'EFS_OnHand',
    ...
    $('#jqGridMain').createJqGrid(option);*/
...
function initFrm() { //init form
	...
	*/
    ...
    $("#searchBtn").on('click', function () { //Seach Btn
        ...
        destroyJqGrid(0);
        createGrid_init();
        gridAttributes[0].gridDefinitionUrl = invokeURL + 'EFS_SN201_Q03_Query';
        createGrid(0);
    });
}
/*---------------------Form Function End--------------*/
...
function createGrid_init() { //create jagrid
    let $grid = $("#" + gridAttributes[0].gid);
    /*
	if ($("#sDate1").val() != '' && $("#eDate1").val() != '' ){				
        console.log(gridAttributes_init.gridDefPostData);
		$grid.createJqGrid(gridAttributes_init);
    }
    */
