...
<!-- 20241028 Eason  [SENAO101-202407-0041] 因目前是使用Meta-eSchool進行績效評核,EFGP系統首頁的「KPI績效評核系統」路徑，已無保留之必要性,故申請移除EFGP系統首頁右下角的「KPI績效評核系統」連結路徑 -->
			...
			function login() {
				...
				if (tUserId == '') {
					...
					if(tIsAlreadySubmit == 0){//Gaspard 2012.09.08 修改
						...
						//資訊服務申請單：SENAO101-202207-0082，By語系增加登入時的提示訊息 By Ann 20220727
						if(document.getElementById("ddlLanguage").value == "en_US"){
							alert("The Ministry of Information reminds:\n1. Please make sure you have permission to log in to this system.\n2. The system you log in contains customer confidential information, please use it with caution and do not disclose it.\n3. The system will record login, logout and other information.");
						}else{
