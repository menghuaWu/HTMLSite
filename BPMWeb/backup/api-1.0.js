...
var apiauth='https://flowportal-t.senao.com/MES/auth'; //正式
var apiurl='https://flowportal-t.senao.com/MES/invoke?sCode='; //正式
...
function batchsign(){	
	window.open("https://flowportal-t.senao.com/BPMWeb/index.html?token="+getcooky("token")+"&username="+getcooky("username"),"_blank");
}
 /*=================================API END=============================================*/
